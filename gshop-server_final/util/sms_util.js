...
function sendCode(phone, code, callback) {
    var ACCOUNT_SID = '8aaf070874af41ee017511254e0e1fd7'; // 可以改成自己的
    var AUTH_TOKEN = '01f102104e4849d6ba4abc623137fe71'; // 可以改成自己的
    var Rest_URL = 'https://app.cloopen.com:8883';
    var AppID = '8aaf070874af41ee017511254ef81fde'; // 可以改成自己的
    //1. 准备请求url
    /*
